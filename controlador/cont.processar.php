...
function obtenirArticles($paginaActual, $articlesPerPagina) {
    ...
    try{
        ...
        $stmt = $pdo->prepare("SELECT id_article, nom, cos, img_path, quantitat_disponible FROM articles LIMIT :limit OFFSET :offset");
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    header("Location: ../vista.formulari.php?pagina=$paginaActual");
    exit();
}
